      ...
      <div class="card">
        <div className='card-body'>
          ...
          <div className='ETH-USDT-box'>
            ...
            <div className='itemm'><div className='item-img'>  <img src="https://s3.coinmarketcap.com/static/img/portraits/62da512ff192d82df80012bb.png" height="30px" alt="item-1" /><span className='item-head'> USDT <br />BEP20</span></div></div>
            <div className='itemm'><div className='item-img'>   <img src="https://cdn.pixabay.com/photo/2021/04/30/16/47/bnb-6219388_1280.png" height="30px" alt="item-1" /><span className='item-head'>BNB</span></div></div>
